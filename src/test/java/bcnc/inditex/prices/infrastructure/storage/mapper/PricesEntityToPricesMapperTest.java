...
class PricesEntityToPricesMapperTest {

    private PricesEntityToPricesMapper pricesEntityToPricesMapper;

    @BeforeEach
    void setup() {
        pricesEntityToPricesMapper = new PricesEntityToPricesMapperImpl();
    }
    ...
    void givenAPriceEntity_whenTryToMapToPrices_thenReturnAPricesModelEntity() {
        ...
        // act
        Prices prices = pricesEntityToPricesMapper.toPrices(pricesEntity);
    ...
    void givenAPriceEntityList_whenTryToMapToPricesList_thenReturnAPricesModelEntityList() {
        ...
        // act
        List<Prices> pricesList = pricesEntityToPricesMapper.toPrices(pricesEntityList);
